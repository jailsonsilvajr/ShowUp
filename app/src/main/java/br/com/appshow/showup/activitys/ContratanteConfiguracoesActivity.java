...
public class ContratanteConfiguracoesActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.contratante_configuracoes_activity);
        Toolbar toolbar = (Toolbar) findViewById(R.id.contratante_configuracoes_toolbar);
        setSupportActionBar(toolbar);

        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.contratante_configuracoes_drawer_layout);
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close);
        drawer.setDrawerListener(toggle);
        toggle.syncState();

        NavigationView navigationView = (NavigationView) findViewById(R.id.contratante_configuracoes_nav_view);
        ...
        ImageView contratante_configuracoes_nav_header_image_background = (ImageView) hView.findViewById(R.id.contratante_configuracoes_nav_header_image_background);
        Button contratante_configuracoes_nav_header_button_configuracao = (Button) hView.findViewById(R.id.contratante_configuracoes_nav_header_button_configuracao);
        CircleImageView contratante_configuracoes_nav_header_image_perfil = (CircleImageView) hView.findViewById(R.id.contratante_configuracoes_nav_header_image_perfil);
        ...
        Button contratante_configuracoes_content_button_conta = (Button) findViewById(R.id.contratante_configuracoes_content_button_conta);
        contratante_configuracoes_content_button_conta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.contratante_configuracoes_drawer_menu_nav_pagina_inicial) {
            return true;
        } if (id == R.id.contratante_configuracoes_drawer_menu_nav_mensagens) {
            return true;
        } if (id == R.id.contratante_configuracoes_drawer_menu_nav_eventos) {
            return true;
        } if (id == R.id.contratante_configuracoes_drawer_menu_nav_favoritos) {
            return true;
        } if (id == R.id.contratante_configuracoes_drawer_menu_nav_sair) {
            this.finish();
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.contratante_configuracoes_drawer_menu_nav_mensagens) {

        } else if (id == R.id.contratante_configuracoes_drawer_menu_nav_eventos) {

        } else if (id == R.id.contratante_configuracoes_drawer_menu_nav_favoritos) {
        ...
        } else if (id == R.id.contratante_configuracoes_drawer_menu_nav_sair) {
