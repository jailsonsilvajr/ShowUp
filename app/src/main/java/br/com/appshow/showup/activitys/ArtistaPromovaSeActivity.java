...
public class ArtistaPromovaSeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView artista_promovase_nav_header_image_background = (ImageView) hView.findViewById(R.id.artista_promovase_nav_header_image_background);
        Button artista_promovase_nav_header_button_configuracao = (Button) hView.findViewById(R.id.artista_promovase_nav_header_button_configuracao);
        CircleImageView artista_promovase_nav_header_image_perfil = (CircleImageView) hView.findViewById(R.id.artista_promovase_nav_header_image_perfil);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.artista_promovase_drawer_menu_nav_pagina_inicial) {
            return true;
        } if (id == R.id.artista_promovase_drawer_menu_nav_agenda) {
            return true;
        } if (id == R.id.artista_promovase_drawer_menu_nav_promova) {
            return true;
        } if (id == R.id.artista_promovase_drawer_menu_nav_historico) {
            return true;
        } if (id == R.id.artista_promovase_drawer_menu_nav_sair) {
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.artista_promovase_drawer_menu_nav_agenda) {

        } else if (id == R.id.artista_promovase_drawer_menu_nav_promova) {

        } else if (id == R.id.artista_promovase_drawer_menu_nav_historico) {

        } else if (id == R.id.artista_promovase_drawer_menu_nav_sair) {
