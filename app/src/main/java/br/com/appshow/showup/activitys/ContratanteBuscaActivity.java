...
public class ContratanteBuscaActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView contratante_busca_nav_header_image_background = (ImageView) hView.findViewById(R.id.contratante_inicio_nav_header_image_background);
        Button contratante_busca_nav_header_button_configuracao = (Button) hView.findViewById(R.id.contratante_inicio_nav_header_button_configuracao);
        CircleImageView contratante_busca_nav_header_image_perfil = (CircleImageView) hView.findViewById(R.id.contratante_inicio_nav_header_image_perfil);
        TextView contratante_busca_nav_header_textview_nome = (TextView) hView.findViewById(R.id.contratante_inicio_nav_header_textview_nome);
        ...
        if(contratante.getUrl_foto_perfil() == null || contratante.getUrl_foto_perfil().equals("")){
            ...
            contratante_busca_nav_header_image_perfil.setImageResource(R.drawable.foto_perfil);
        }else{

            Picasso.with(this)
                    .load(contratante.getUrl_foto_perfil())
                    .into(contratante_busca_nav_header_image_perfil);
        }
        if(contratante.getNome().equals("")){

            contratante_busca_nav_header_textview_nome.setText("Nome");
        }else{
