...
public class EnderecoUsuario implements Parcelable{
    ...
    protected EnderecoUsuario(Parcel in) {
    ...
    public static final Creator<EnderecoUsuario> CREATOR = new Creator<EnderecoUsuario>() {
        ...
        public EnderecoUsuario createFromParcel(Parcel in) {
            return new EnderecoUsuario(in);
        }

        @Override
        public EnderecoUsuario[] newArray(int size) {
            return new EnderecoUsuario[size];
        }
    };
